...
public class Invoice_ActionListeners implements ActionListener, ListSelectionListener  {
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                if (result == JFileChooser.APPROVE_OPTION) {
                    ...
                    frame.setInvoiceHeaderTableModel(new InvoiceHeader_TblModel(frame.getInvoicesList()));
    ...
    private void invoicesTableRowSelected() {
        ...
        if (selectedRowIndex >= 0) {
            InvoiceHeader row = frame.getInvoiceHeaderTableModel().getInvoicesHList().get(selectedRowIndex);
            ...
            frame.setInvoiceLinesTableModel(new InvoiceLine_TblModel(lines));
    ...
    private void createLineOK() {
        ...
        InvoiceHeader invoice = frame.getInvoiceHeaderTableModel().getInvoicesHList().get(headerIndex);
    ...
    private void deleteInvoice() {
        ...
        InvoiceHeader header = frame.getInvoiceHeaderTableModel().getInvoicesHList().get(invIndex);
        frame.getInvoiceHeaderTableModel().getInvoicesHList().remove(invIndex);
        frame.getInvoiceHeaderTableModel().fireTableDataChanged();
        frame.setInvoiceLinesTableModel(new InvoiceLine_TblModel(new ArrayList<InvoiceLine>()));
        frame.getInvLinesTable().setModel(frame.getInvoiceLinesTableModel());
        frame.getInvoiceLinesTableModel().fireTableDataChanged();
